  ...
  template: `
    <section class="page-hero" data-reveal>
      <div class="page-hero__inner">
        ...
        <p class="page-hero__sub">Elevando el estilo de vida felino a través de experiencias diseñadas por el equipo de Las Chubys.</p>
      </div>
    </section>
...
export class ServiciosComponent {
  ...
  constructor() {
    this.seo.setPage('Servicios | Las Chubys', 'Servicios y colaboraciones editoriales del universo Las Chubys.', '/images/cats/iris3.jpeg', '/servicios');
  }
}
