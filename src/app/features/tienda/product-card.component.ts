...
@Component({
  ...
  template: `
    <article class="product-card">
      <div class="product-card__badge">{{ product().source === 'owned' ? 'Las Chubys' : 'Afiliado' }}</div>
      ...
      <div class="product-card__actions">
        <button class="button-secondary" type="button" (click)="preview.emit(product())">Ver rápido</button>
